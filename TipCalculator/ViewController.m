...
- (void) viewDidLoad {
    ...
    [self setupTextField: self.tipAmountTextField];
...
- (IBAction) calculateTip: (id) sender {
    ...
    self.tipAmountLabel.text = [self.tipModel calculateTip: self.billAmountTextField.text tipPercent: self.tipAmountTextField.text];
